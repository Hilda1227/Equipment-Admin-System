<template>
  <div class=" wrap comfirm-receive">
    ...
    <x-button class="btn" type="primary"
      @click.native = "this.priorReturn({br_id: this.br_id})" 
...
export default {
  ...
  created() {
    switch(this.type){
      case "borrowing":
	      this.title = "借用时间，剩余n天"; this.btn_text = "提前还"; break;
      case "hasTimeoutReturn":
          this.title = "归还时间 已逾期n天"; this.btn_text = "归还"; break;
      case "checking":
        this.title = "等待通过审核"; this.btn_text = "审核中"; break;
      case "waitComfirmReturn":
        this.title = "已移交于借出社团"; this.btn_text = "正在途中"; break;
    }
